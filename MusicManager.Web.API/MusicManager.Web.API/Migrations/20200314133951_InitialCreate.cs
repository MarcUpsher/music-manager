        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAdded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 14, 15, 39, 49, 751, DateTimeKind.Local).AddTicks(4999)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAdded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 14, 15, 39, 49, 732, DateTimeKind.Local).AddTicks(9981)),
                    DateDeleted = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 300, nullable: true),
                    DateAdded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 14, 15, 39, 49, 765, DateTimeKind.Local).AddTicks(1345)),
                    DateModified = table.Column<DateTime>(nullable: true),
                    DateDeleted = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAdded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 14, 15, 39, 49, 772, DateTimeKind.Local).AddTicks(9424)),
                    DateModified = table.Column<DateTime>(nullable: true),
                    DateDeleted = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbumId = table.Column<int>(nullable: false),
                    GenreId = table.Column<int>(nullable: false),
                    DateAdded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 14, 15, 39, 49, 794, DateTimeKind.Local).AddTicks(2668)),
                    DateDeleted = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 300, nullable: true),
                    DateAdded = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 14, 15, 39, 49, 782, DateTimeKind.Local).AddTicks(8613)),
                    DateModified = table.Column<DateTime>(nullable: true),
                    DateDeleted = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
