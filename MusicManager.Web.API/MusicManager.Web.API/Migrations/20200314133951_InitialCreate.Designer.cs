...
namespace MusicManager.Web.API.Migrations
{
    ...
    [Migration("20200314133951_InitialCreate")]
            ...
            modelBuilder.Entity("MusicManager.Web.API.Domain.Models.Album", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        ...
                        .HasDefaultValue(new DateTime(2020, 3, 14, 15, 39, 49, 772, DateTimeKind.Local).AddTicks(9424));
            ...
            modelBuilder.Entity("MusicManager.Web.API.Domain.Models.AlbumGenre", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 14, 15, 39, 49, 794, DateTimeKind.Local).AddTicks(2668));
            ...
            modelBuilder.Entity("MusicManager.Web.API.Domain.Models.Artist", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 14, 15, 39, 49, 765, DateTimeKind.Local).AddTicks(1345));
            ...
            modelBuilder.Entity("MusicManager.Web.API.Domain.Models.Genre", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 14, 15, 39, 49, 751, DateTimeKind.Local).AddTicks(4999));
            ...
            modelBuilder.Entity("MusicManager.Web.API.Domain.Models.ImageRef", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 14, 15, 39, 49, 732, DateTimeKind.Local).AddTicks(9981));
            ...
            modelBuilder.Entity("MusicManager.Web.API.Domain.Models.Track", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdded")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 14, 15, 39, 49, 782, DateTimeKind.Local).AddTicks(8613));
